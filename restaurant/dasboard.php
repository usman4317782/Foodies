...
<body>
  <div class="container">
    <h1 class=" text text-center text-uppercase text-primary mt-5 ">Welcome to
      Restaurant Owner dashboard
    </h1>

    <hr>

    <a href="add_resturaunt.php" class="btn btn-outline-success">Add New</a>
    <a href="resturaunt_list.php" class="btn btn-outline-primary">Resturaunt List/Orders Detail</a>
