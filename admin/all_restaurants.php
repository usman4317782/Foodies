      ...
      <tbody id="tableBody">
        ...
        <tr>
          ...
          <td>
            ...
            <a href="admin_book_order.php?action=book_order&rest_id=<?php echo $restaurant['RestaurantID'];?>&offer_id=<?php echo $offer['OfferID']; ?>"
              class="btn btn-sm btn-success">Book Order</a>
            <?php endif; ?>
            <?php endforeach; ?>
            <?php endif; ?>
          </td>
